...
#LOAD DATASET: MNIST_________________________________________________________________________________________________________________________________________
...
#LOAD CLASSIFIER MODEL______________________________________________________________________________________________________________________________________
...
#PREDICTION ON NORMAL TEST SET______________________________________________________________________________________________________________________________
...
idx = np.load("./attacks/mnist_1_deep_index.npy")
y_att = y_test[idx]
x_att = np.load("./attacks/mnist_1_deep_samples.npy")

print("Attack Set shape: ", x_att.shape)

#PREDICTION ON ATTACKS_______________________________________________________________________________________________________________________________________
...
detector = FeatureSqueezingDetector(model, "FeatureSqueezing?squeezers=bit_depth_1,median_filter_2_2&distance_measure=l1", "MNIST")
